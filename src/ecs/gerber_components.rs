...
impl Position3D {
    ...
    pub fn from_2d(pos: &crate::ecs::components::Position, z: f64) -> Self {
        Self { x: pos.x, y: pos.y, z }
    }

    pub fn to_2d(&self) -> crate::ecs::components::Position {
        crate::ecs::components::Position::new(self.x, self.y)
    }
}
...
impl LayerTypeExt for LayerType {
    ...
    fn default_material(&self) -> MaterialProperties {
        match self {
            ...
            LayerType::TopSilk | LayerType::BottomSilk => MaterialProperties::soldermask(), // Similar properties
            LayerType::TopPaste | LayerType::BottomPaste => MaterialProperties::copper(), // Solder paste
